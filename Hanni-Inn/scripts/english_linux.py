...
# first room
        ...
        i35 = Label(d, text="-Wi-Fi included ", font=('Dotum', 10), bg="#F0F0FF")
        i35.place(x=70, y=380)

        i36 = Label(d, text="-Stores nearby", font=('Dotum', 10), bg="#F0F0FF")
        i36.place(x=70, y=410)

        i37 = Label(d, text="- Quiet area", font=('Dotum', 10), bg="#F0F0FF")
        i37.place(x=70, y=440)

        i38 = Label(d, text="- Tourism zone, font=('Dotum', 10), bg="#F0F0FF")
